...
The Ember provider embeds their dataset in the grid-intensity CLI. The data
uses ISO 3 char country codes. However we want to also support 2 char ISO codes.

Ideally this will be added by Ember in a future release. Until then we can use a
simple Go program in the `hack` directory.
